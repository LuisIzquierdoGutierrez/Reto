...
public class Actividad_Aprobada {
    private int id;
    ...
    public Actividad_Aprobada(int id, int id_solicitante, String titulo, String comentario_actividad, A_Tipo tipo, boolean prevista, A_Estado estado, String comentario_estado, boolean transporte, boolean alojamiento, LocalDateTime inicio, LocalDateTime fin) {
        this.id = id;
