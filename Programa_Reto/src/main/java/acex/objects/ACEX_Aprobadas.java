...
public class ACEX_Aprobadas {
    ...
    public ACEX_Aprobadas(int id_aprobada, int idSolicitante, String titulo, String comentario_actividad, Tipo_Actividad tipo, boolean programada, Tipo_Estado estado, String comentario_estado, boolean transporte, boolean alojamiento, LocalTime hora_inicio, LocalTime hora_fin, LocalDate fecha_inicio, LocalDate fecha_fin) {
