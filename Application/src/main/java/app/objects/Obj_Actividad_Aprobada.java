...
/**
 * Esta clase representa una actividad aprobada en la aplicación.
 */
public class Obj_Actividad_Aprobada {
    ...
    /**
     * Constructor de la clase Obj_Actividad_Aprobada.
     * 
     * @param id                  El ID de la actividad.
     * @param idSolicitante       El ID del solicitante de la actividad.
     ...
     * @param prevista            Indica si la actividad está prevista o no.
...
/**
    ...
    /**
     * Obtiene el solicitante de la actividad.
     * 
     * @return El solicitante de la actividad.
     */
    ...
    /**
     * Establece el solicitante de la actividad.
     * 
     * @param solicitante El solicitante de la actividad.
     */
